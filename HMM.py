...
class HMM(object):
    ...
    def __init__(self,dirname : str) -> None:
        ...
        self.data,self.tags,self.word_tag_pairs = self.prepare_training(pd.read_csv(f"{dirname}\\train.csv",na_filter=False)) # I used windows so change \\ to /
    ...
    def classification(self,pairs=None):
        ...
        for actual,predicted in zip(pairs,self.dp_viterbi_algorithm(*self.create_transition_matrix(),(tup[0] for tup in pairs))):
